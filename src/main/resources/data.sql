...
(1, 'https://cualbondi.com.ar/media/poi.webp/poi-cines-aana-san-juan.880x300.webp', 'C/ Callejón, 2', 'San Juan', 'Alicante', '23654'),
...
(4, 'Lauren LaVera, David Howard Thornton', 4, 'Dark Age Cinema','Estados Unidos', 'Damien Leone', 138,'Paul Wiley', 'George Steuber','https://static.cinepolis.com/resources/mx/movies/posters/414x603/41279-249462-20221226031358.jpg' ,2, 'Después de ser resucitado por una entidad siniestra Art the Clown regresa al condado de Miles donde debe cazar y destruir a una adolescente y a su hermano menor en la noche de Halloween.','Damien Leone', 'Terrifier 2', 'https://www.youtube.com/watch?v=6KkONLf_ZKU', 2022),
...
(27, 'Animación', 0, 'Magic Light Pictures', 'Reino Unido', 'Samantha Cutler, Daniel Snaddon', 26, 'René Aubry', 'Animación', 'https://cinesembajadores.es/wp-content/uploads/2023/02/bill-i-janet_WEB1200X1800_ESP.jpg', 2, 'Bill y Janet se enamoran mientras sus familias están en guerra. Ante la desaprobación de su entorno, huyen a un planeta lejano y sus familias deben dejar de lado sus diferencias y trabajar juntos para traerlos de regreso a casa.', 'Julia Smuts Louw', 'Bill y Janet y otras crónicas', 'https://www.youtube.com/watch?v=r2Iwz-Ik8pA', 2022),
