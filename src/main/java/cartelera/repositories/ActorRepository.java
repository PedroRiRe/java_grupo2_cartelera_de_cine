...
public interface ActorRepository extends JpaRepository<Cinema, Long> {
    ...
    // @Query("select cinema from Actor actor left join fetch cinema.rooms where cinema.id = :id")
